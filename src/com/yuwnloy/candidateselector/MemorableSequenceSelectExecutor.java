...
public class MemorableSequenceSelectExecutor<T> extends AbstractSelectExecutor<T>{
	...
	protected void setCurrentIndex(int index){
		if(this.getCandidateCount()>0&&index<this.getCandidateCount())
	...
	public boolean canSelect(){
		if(this.getCandidateCount()>0&&this.currentIndex<this.getCandidateCount())
			return true;
		return false;
	}
	/**
	...
	public T getCandidate(){
		if(this.canSelect())
			return this.getCandidate(this.currentIndex);
		return null;
	}
}
